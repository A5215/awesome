...
-- beautiful init
beautiful.init(os.getenv("HOME") .. "/.config/awesome/themes/monocolor/theme.lua")

-- common
modkey     = "Mod4"
altkey     = "Mod1"
terminal   = "gnome-terminal" or "terminology" or "terminator" or "urxvtc" or "xterm"
...
mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
                                    { "soft", menugen.build_menu() },
                                    { "open terminal", terminal },
                                    { "power", poweroffmenu, beautiful.poweroff_icon },
                                  }
                        })
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey }, key_p, function() os.execute("screenshot") end),
    ...
    awful.key({ altkey }, key_k,
        function ()
            awful.client.focus.byidx( 1)
            if client.focus then client.focus:raise() end
        end),
    awful.key({ altkey }, key_j,
        function ()
            awful.client.focus.byidx(-1)
            if client.focus then client.focus:raise() end
        end),
    ...
    awful.key({ modkey }, key_h,
        function()
            awful.client.focus.bydirection("left")
            if client.focus then client.focus:raise() end
        end),
    awful.key({ modkey }, key_l,
        function()
    ...
    -- Show Menu
    awful.key({ modkey }, key_w,
        function ()
            mymainmenu:show({ keygrabber = true })
        end),

    -- Show/Hide Wibox
    awful.key({ modkey }, key_b, function ()
    ...
    awful.key({ altkey, "Shift"   }, key_l,      function () awful.tag.incmwfact( 0.05)     end),
    awful.key({ altkey, "Shift"   }, key_h,      function () awful.tag.incmwfact(-0.05)     end),
    ...
    -- Dropdown terminal
    awful.key({ modkey,	          }, key_z,      function () drop(terminal) end),

    -- Widgets popups
    awful.key({ altkey,           }, key_c,      function () lain.widgets.calendar:show(7) end),
    awful.key({ altkey,           }, key_h,      function () fswidget.show(7) end),
    awful.key({ altkey,           }, key_w,      function () myweather.show(7) end),
    ...
    -- Copy to clipboard
    awful.key({ modkey }, key_c, function () os.execute("xsel -p -o | xsel -i -b") end),

    -- User programs
    awful.key({ modkey }, key_q, function () awful.util.spawn(browser) end),
    awful.key({ modkey }, key_i, function () awful.util.spawn(browser2) end),
    awful.key({ modkey }, key_s, function () awful.util.spawn(gui_editor) end),
    awful.key({ modkey }, key_g, function () awful.util.spawn(graphics) end),
